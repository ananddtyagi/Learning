        ...
        <form className={classes.container} onSubmit={this.handleSubmit} autoComplete="off" noValidate={(this.props.novalidate) ? this.props.novalidate : false}>
          {fields.map(formField => {
            ...
            switch(formField.type) {
              case 'radio': //required is putting the asterix after the quetsion, move to before instead
                field = <FormControl component="fieldset"  className={classes.textField} key={`form-control-${formField.name}`}>
